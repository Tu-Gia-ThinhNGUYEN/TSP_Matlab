...
pathSaveImage="../images/mTSP/mTSP";
for loop=1:5
    %% Input parameters
    ...
    diary(pathSaveImage+"mTSP"+num2str(n)+"_"+num2str(m)+".txt");
    ...
    filename = pathSaveImage+num2str(n)+"_"+num2str(m)+"_"+num2str(loop)+".png"
    saveas(gcf,filename)
    diary('off');
end
% for i=1:n+1+sales-1
